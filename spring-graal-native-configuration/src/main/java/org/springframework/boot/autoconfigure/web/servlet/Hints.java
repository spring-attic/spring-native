...
@NativeImageHint(trigger=WebMvcAutoConfiguration.class, typeInfos = {
		@TypeInfo(types= {AnnotationConfigServletWebServerApplicationContext.class,
				...
				DefaultFormattingConversionService.class,WebConversionService.class,ConfigurableConversionService.class,GenericConversionService.class,
				WsContextListener.class, WsFilter.class,
				CodecConfigurer.class,AbstractGenericHttpMessageConverter.class,AbstractHttpMessageConverter.class,GenericHttpMessageConverter.class,AbstractJackson2HttpMessageConverter.class,
