...
public class LiteConfigurationInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
    ...
    public void initialize(GenericApplicationContext applicationContext) {
       applicationContext.addBeanFactoryPostProcessor(new LiteConfigurationPostProcessor());
    }

    static class LiteConfigurationPostProcessor implements BeanDefinitionRegistryPostProcessor {
                    ...
                    if (typeName != null && ClassUtils.isPresent(typeName.replace("$", "_") + "Cached", null)) {
                        bean = new AnnotatedGenericBeanDefinition(anno.getMetadata()) {
                            ...
                            public void setAttribute(String name, Object value) {
                                if (name.equals(
                                        "org.springframework.context.annotation.ConfigurationClassUtils.configurationClass")) {
