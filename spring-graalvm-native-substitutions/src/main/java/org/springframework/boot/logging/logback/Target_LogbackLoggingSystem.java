...
@TargetClass(className = "org.springframework.boot.logging.logback.LogbackLoggingSystem", onlyWith = { OnlyIfPresent.class, LogbackIsAround.class, RemoveXmlSupport.class })
