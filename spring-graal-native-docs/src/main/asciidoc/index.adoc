...
* If the application is going to reflect at runtime on some type, field, method, orconstructor, the native image must include the data to satisfy those reflection requests.
