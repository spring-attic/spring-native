 ...
 */
@NativeImageHint(trigger = LettuceConnectionConfiguration.class, typeInfos = {
...
@NativeImageHint(trigger = RedisAutoConfiguration.class, typeInfos = {
		@TypeInfo(types = {
...
@NativeImageHint(trigger = RedisRepositoriesAutoConfiguration.class, typeInfos = {
		@TypeInfo(types = {
