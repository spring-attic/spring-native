...
/**
 * Failure analyzer for missing native configuration which results in {@link NoSuchMethodException}.
 *
...
public class NoSuchMethodExceptionNativeFailureAnalyzer extends AbstractFailureAnalyzer<NoSuchMethodException>  {
	...
	private static final String ACTION = String.format(
			"Native configuration for a method accessed reflectively is likely missing.%n"
	...
	@Override
	protected FailureAnalysis analyze(Throwable rootFailure, NoSuchMethodException ex) {
