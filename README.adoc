...
You can also directly use the base images available on Docker hub:

 - Ubuntu bionic + GraalVM native: https://hub.docker.com/r/springci/graalvm-ce/tags

 - Ubuntu bionic + GraalVM native + utilities required to build `spring-graalvm-native`: https://hub.docker.com/r/springci/spring-graalvm-native/tags
