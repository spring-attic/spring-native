...
GraalVM issues impacting Spring are identified on their bugtracker https://github.com/oracle/graal/labels/spring[by the `spring` label].
...
When it recognizes certain usage scenarios, Spring Native will try to set the required flags automatically.
