                ...
                <plugins>
                    ...
                    <plugin>
                        ...
                        <configuration>
                            ...
                            <buildArgs>-Dspring.backgroundpreinitializer.ignore=true -Dspring.native.mode=hybrid -Dspring.native.remove-yaml-support=true -Dspring.spel.ignore=true -Dspring.xml.ignore=true -Dspring.native.remove-jmx-support=true</buildArgs>
                        </configuration>
                        <executions>
                            <execution>
                                <goals>
...
Then, running `mvn -Phybrid-native clean package` will do everything from end-to-end. It will compile the app, 
