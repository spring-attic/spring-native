...
* `-Dspring.native.mode=default|agent|functional` switches how much configuration the feature actually provides
to native-image.  By default, it provides everything (including deep analysis of auto-configuration).
