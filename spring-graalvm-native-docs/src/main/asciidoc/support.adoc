...
https://github.com/spring-projects-experimental/spring-graalvm-native/issues/409[Kotlin Coroutines are not yet supported].
...
IMPORTANT: `spring-graalvm-native` {version} is designed to be used with Spring Cloud {cloud-version}.
