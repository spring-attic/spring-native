...
public class CLR implements CommandLineRunner {
	...
	private void runPagingAndSorting(LineItem product1, LineItem product2, LineItem product3) {
		...
		orderRepository.save(newOrder("o2", "c42", product1)).block();
		orderRepository.save(newOrder("o3", "c42", product2)).block();
		orderRepository.save(newOrder("o4", "c42", product3)).block();
		orderRepository.save(newOrder("o5", "b12", product1)).block();
		orderRepository.save(newOrder("o6", "b12", product1)).block();
