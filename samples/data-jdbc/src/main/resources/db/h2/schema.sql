...
CREATE TABLE IF NOT EXISTS Lego_Set (id INTEGER, name VARCHAR(100), min_Age INTEGER, max_Age INTEGER, created_at DATETIME, updated_at DATETIME, created_by varchar(100), modified_by varchar(100));
