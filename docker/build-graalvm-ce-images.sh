...
docker build \
  --build-arg JVMCI_URL=https://github.com/graalvm/graal-jvmci-8/releases/download/jvmci-20.2-b03/openjdk-8u262+10-jvmci-20.2-b03-fastdebug-linux-amd64.tar.gz \
  --build-arg GRAALVM_BRANCH=release/graal-vm/20.2 \
  -t springci/graalvm-ce:20.2-dev-java8 - < $DIR/Dockerfile.graalvm-ce

docker build \
  --build-arg JVMCI_URL=https://github.com/graalvm/labs-openjdk-11/releases/download/jvmci-20.2-b03/labsjdk-ce-11.0.8+10-jvmci-20.2-b03-debug-linux-amd64.tar.gz \
  --build-arg GRAALVM_BRANCH=release/graal-vm/20.2 \
